function [path, path_length] = LSL(fig, x_init, x_goal, r, plot_circles, plot_tangents, plot_path)
    % Function to compute Dubins LSL
    ...
    path_length = dubinsPath(fig, x_init, x_goal, r, "LSL", "k-", 2, plot_tangents, plot_path);
