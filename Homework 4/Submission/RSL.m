function [path, path_length] = RSL(fig, x_init, x_goal, r, plot_circles, plot_tangents, plot_path)
    ...
    path_length = dubinsPath(fig, x_init, x_goal, r, "RSL", "k-", 2, plot_tangents, plot_path);   
